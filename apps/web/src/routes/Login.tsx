...
function Login (){
    ...
    return (
      <div id={styles.login}>
        ...
        <input type="email" name="email" placeholder="digite seu e-mail..." onChange={updateEmail}/>
        <input type="password" name="password" placeholder="digite sua senha..." onChange={updatePassword}/>
        <button type="submit" onClick={()=>{connect(email, password)}}>Logar</button>
      </div>
    );
}
